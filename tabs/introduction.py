...
#PARTIE "Introduction du projet"
    ...
    st.write("<strong>1. Objectif 1 : Constater le réchauffement climatique et l’augmentation des gaz à effet de serre :</strong>", unsafe_allow_html=True)
    ...
    st.write("<strong>2. Objectif 2 : Modéliser un algorithme de machine learning pour tenter de prédire les changements de températures pour l’année 2024, à l’échelle mondiale :</strong>", unsafe_allow_html=True)
