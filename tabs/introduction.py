...
#PARTIE "Introduction du projet"
    ...
    st.write("<strong>2. Objectif 2 : Modéliser un algorithme de machine learning pour tenter de prédire les changements de températures pour les prochaines années, à l’échelle mondiale :</strong>", unsafe_allow_html=True)
